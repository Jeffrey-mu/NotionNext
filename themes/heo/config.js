const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://notion-next-ashy-five.vercel.app/?theme=heo' },
    { title: '“种一棵树最好的时间是十年前，而后是现在”。', url: '#' },
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '分享编程',
  HERO_TITLE_2: '记录生活',
  HERO_TITLE_3: 'jiafengfmc.cn',
  HERO_TITLE_4: '最新动态',
  HERO_TITLE_5: '上班 摸鱼 下班',
  HERO_TITLE_LINK: 'https://github.com/Jeffrey-mu',
  ...
  INFO_CARD_URL: 'https://github.com/Jeffrey-mu/NotionNext', // 个人资料底部按钮链接
