...
const BLOG = {
  ...
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'ac123997803a4734abf7b7851d9dfc1b',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jeffrey', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-ashy-five.vercel.app/', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Jeffrey-mu', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  // ----> 站点统计
  ANALYTICS_VERCEL: process.env.NEXT_PUBLIC_ANALYTICS_VERCEL || false, // vercel自带的统计 https://vercel.com/docs/concepts/analytics/quickstart https://github.com/Jeffrey-mu/NotionNext/issues/897
